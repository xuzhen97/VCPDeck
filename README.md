...
```bash
pi install git:github.com/xuzhen97/VCPDeck@v0.6.27
```
...
pnpm \
  ...
  add \
  "github:xuzhen97/VCPDeck#v0.6.27&path:/packages/sdk" \
  "github:xuzhen97/VCPDeck#v0.6.27&path:/packages/shared"
```
