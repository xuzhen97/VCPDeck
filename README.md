...
```bash
pi install git:github.com/xuzhen97/VCPDeck@v0.8.5
```
...
pnpm \
  ...
  add \
  "github:xuzhen97/VCPDeck#v0.8.5&path:/packages/sdk" \
  "github:xuzhen97/VCPDeck#v0.8.5&path:/packages/shared"
```
