...
```bash
pi install git:github.com/xuzhen97/VCPDeck@v0.10.0
```
...
pnpm \
  ...
  add \
  "github:xuzhen97/VCPDeck#v0.10.0&path:/packages/sdk" \
  "github:xuzhen97/VCPDeck#v0.10.0&path:/packages/shared"
```
