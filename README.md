...
```bash
pi install git:github.com/xuzhen97/VCPDeck@v0.6.10
```
...
pnpm \
  ...
  add \
  "github:xuzhen97/VCPDeck#v0.6.10&path:/packages/sdk" \
  "github:xuzhen97/VCPDeck#v0.6.10&path:/packages/shared"
```
