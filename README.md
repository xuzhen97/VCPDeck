...
```bash
pi install git:github.com/xuzhen97/VCPDeck@v0.8.17
```
...
pnpm \
  ...
  add \
  "github:xuzhen97/VCPDeck#v0.8.17&path:/packages/sdk" \
  "github:xuzhen97/VCPDeck#v0.8.17&path:/packages/shared"
```
