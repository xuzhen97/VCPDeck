...
```bash
pi install git:github.com/xuzhen97/VCPDeck@v0.8.12
```
...
pnpm \
  ...
  add \
  "github:xuzhen97/VCPDeck#v0.8.12&path:/packages/sdk" \
  "github:xuzhen97/VCPDeck#v0.8.12&path:/packages/shared"
```
