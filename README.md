...
```bash
pi install git:github.com/xuzhen97/VCPDeck@v0.8.16
```
...
pnpm \
  ...
  add \
  "github:xuzhen97/VCPDeck#v0.8.16&path:/packages/sdk" \
  "github:xuzhen97/VCPDeck#v0.8.16&path:/packages/shared"
```
