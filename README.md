...
```bash
pi install git:github.com/xuzhen97/VCPDeck@v0.8.4
```
...
pnpm \
  ...
  add \
  "github:xuzhen97/VCPDeck#v0.8.4&path:/packages/sdk" \
  "github:xuzhen97/VCPDeck#v0.8.4&path:/packages/shared"
```
