...
```bash
pi install git:github.com/xuzhen97/VCPDeck@v0.8.6
```
...
pnpm \
  ...
  add \
  "github:xuzhen97/VCPDeck#v0.8.6&path:/packages/sdk" \
  "github:xuzhen97/VCPDeck#v0.8.6&path:/packages/shared"
```
