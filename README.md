...
```bash
pi install git:github.com/xuzhen97/VCPDeck@v0.8.14
```
...
pnpm \
  ...
  add \
  "github:xuzhen97/VCPDeck#v0.8.14&path:/packages/sdk" \
  "github:xuzhen97/VCPDeck#v0.8.14&path:/packages/shared"
```
