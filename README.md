...
```bash
pi install git:github.com/xuzhen97/VCPDeck@v0.6.9
```
...
pnpm \
  ...
  add \
  "github:xuzhen97/VCPDeck#v0.6.9&path:/packages/sdk" \
  "github:xuzhen97/VCPDeck#v0.6.9&path:/packages/shared"
```
