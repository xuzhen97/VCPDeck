...
```bash
pi install git:github.com/xuzhen97/VCPDeck@v0.7.1
```
...
pnpm \
  ...
  add \
  "github:xuzhen97/VCPDeck#v0.7.1&path:/packages/sdk" \
  "github:xuzhen97/VCPDeck#v0.7.1&path:/packages/shared"
```
