...
```bash
pi install git:github.com/xuzhen97/VCPDeck@v0.8.7
```
...
pnpm \
  ...
  add \
  "github:xuzhen97/VCPDeck#v0.8.7&path:/packages/sdk" \
  "github:xuzhen97/VCPDeck#v0.8.7&path:/packages/shared"
```
