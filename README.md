...
```bash
pi install git:github.com/xuzhen97/VCPDeck@v0.8.2
```
...
pnpm \
  ...
  add \
  "github:xuzhen97/VCPDeck#v0.8.2&path:/packages/sdk" \
  "github:xuzhen97/VCPDeck#v0.8.2&path:/packages/shared"
```
