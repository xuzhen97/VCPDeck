...
export async function handleListRoots(client, params) {
...
export async function handleMakeDirectory(client, params) {
    const clientFilter = String(params.clientId || params.clientName || params.client || "");
...
export async function handleStatFile(client, params) {
    const clientFilter = String(params.clientId || params.clientName || params.client || "");
    const filePath = String(params.path || "");
    if (!clientFilter || !filePath) {
        throw new Error("Missing required parameters: clientId (or client), path");
...
export async function handleListDirectory(client, params) {
    const clientFilter = String(params.clientId || params.clientName || params.client || "");
    const filePath = String(params.path || "");
    if (!clientFilter) {
        throw new Error("Missing required parameter: clientId (or client)");
...
export async function handleReadFile(client, params) {
    const clientFilter = String(params.clientId || params.clientName || params.client || "");
    const filePath = String(params.path || "");
...
export async function handleWriteFile(client, params) {
    const clientFilter = String(params.clientId || params.clientName || params.client || "");
    const filePath = String(params.path || "");
...
export async function handleDeleteFile(client, params) {
    const clientFilter = String(params.clientId || params.clientName || params.client || "");
    const filePath = String(params.path || "");
    if (!clientFilter || !filePath) {
        throw new Error("Missing required parameters: clientId (or client), path");
...
export async function handleMoveFile(client, params) {
    const clientFilter = String(params.clientId || params.clientName || params.client || "");
