 ...
 */
export function isRootEquivalent(client) {
 ...
 */
export function formatPrivilegeSummary(client) {
    const p = readPrivileged(client);
    if (!p)
        return "未报告";
 ...
 */
export function rootEquivalentWarning(client) {
    if (!isRootEquivalent(client))
        return null;
    return ("警告: 该机器具备 root 等价特权，可执行任意 root 命令。" +
