...
const STATUS_FILTERS = new Set([...Object.values(JobStatus), "active"]);
...
export async function runJobsCommand(subcommand, argv, context = {}) {
...
export async function waitForTerminalJob(client, jobId, timeoutSeconds, log, pollIntervalMs) {
...
function formatJobsList(result) {
    const sorted = [...result.data].sort((a, b) => {
        const active = (job) => job.status === JobStatus.RUNNING ||
