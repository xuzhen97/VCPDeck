...
const defaultClient = new VcpDeckClient({ baseUrl: "", auth: { type: "cookie" } });
const SdkContext = createContext<VcpDeckClient>(defaultClient);

/** 向 React 组件提供 VCPDeck SDK。 */
export function SdkProvider({ client = defaultClient, children }: { client?: VcpDeckClient; children: ReactNode }) {
