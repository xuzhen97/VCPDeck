...
export function FileDetail({
	...
	useEffect(() => {
		...
		sdk.files
			.readText(clientId, rootDir, relativePath, 262144, controller.signal)
		...
		<Card>
			...
			<CardContent className="space-y-4">
				...
				{entry.kind === "file" && !message && (
					<textarea
						aria-label="文件内容"
						className="min-h-52 w-full rounded-lg border border-input bg-background/60 p-3 font-mono text-sm"
						value={content}
