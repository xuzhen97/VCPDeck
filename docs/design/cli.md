...
> 状态：Current｜维护责任：CLI/SDK 维护者｜最后核验：2026-09-11｜适用版本：`0.6.29` / 当前 `main`
...
```bash
pi install git:github.com/xuzhen97/VCPDeck@v0.6.29
```
...
pnpm \
  ...
  add \
  "github:xuzhen97/VCPDeck#v0.6.29&path:/packages/sdk" \
  "github:xuzhen97/VCPDeck#v0.6.29&path:/packages/shared"
```
