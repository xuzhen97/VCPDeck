...
This project is indexed by GitNexus as **VCPDeck** (393 symbols, 599 relationships, 9 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
